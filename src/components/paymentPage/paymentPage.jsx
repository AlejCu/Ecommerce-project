...
function PaymentPage({ cartItems, cartTotal, dispatch }) {
    ...
    useEffect(() => {
        ...
        const handleSubmit = (e) => {
            ...
            if (hasErrors) {
                ...
                if (statusImg) {
                    ...
                    statusImg.src = process.env.PUBLIC_URL + "/assets/Img/denied-submit.webp";
            }
        ...
        return;
            ...
            if (statusImg) {
                statusImg.style.display = "block";
                statusImg.src = process.env.PUBLIC_URL + "/assets/Img/success-submit.webp";
            }
                ...
                <div className="payment_method-container">
                    <div className="payment_method-child-container">
                        ...
                        <div className="payment_method-status">
                            <img id="status-icon" src={process.env.PUBLIC_URL + "/assets/Img/payment-form-default.webp"} alt="Status Icon" fetchPriority="high"/>
