...
export const products = [
    {
        ...
        name: 'Black Pants',
        price: 650,
        image: process.env.PUBLIC_URL + '/assets/Img/black-pants.webp',
...

    {
        ...
        price: 1300,
        image: process.env.PUBLIC_URL + '/assets/Img/white-blck-sneakers.webp',
...

    {
        ...
        name: 'Blue Jeans',
        price: 750,
        image: process.env.PUBLIC_URL + '/assets/Img/jeans.webp',
...

    {
        ...
        name: 'Green Shirt',
        price: 350,
        image: process.env.PUBLIC_URL + '/assets/Img/green-shirt.webp',
...

    {
        ...
        price: 1400,
        image: process.env.PUBLIC_URL + '/assets/Img/white-rd-sneakers.webp',
...

    {
        ...
        name: 'Red Shirt',
        price: 300,
        image: process.env.PUBLIC_URL + '/assets/Img/red-panda-shirt.webp',
...

    {
        ...
        name: 'Black sneakers',
        price: 1200,
        image: process.env.PUBLIC_URL + '/assets/Img/black-sneakers.webp',
...

    {
        ...
        name: 'Green Pants',
        price: 550,
        image: process.env.PUBLIC_URL + '/assets/Img/green-pants.webp',
...

    {
        ...
        name: 'Red Sneakers',
        price: 1100,
        image: process.env.PUBLIC_URL + '/assets/Img/red-sneakers.webp',
...

    {
        ...
        name: 'Brown Pants',
        price: 600,
        image: process.env.PUBLIC_URL + '/assets/Img/brown-pants.webp',
...

    {
        ...
        name: 'Blue Shirt',
        price: 400,
        image: process.env.PUBLIC_URL + '/assets/Img/two-clr-shirt.webp',
...

    {
        ...
        price: 1250,
        image: process.env.PUBLIC_URL + '/assets/Img/blck-bl-sneakers.webp',
...

    {
        ...
        name: 'Black Shirt',
        price: 450,
        image: process.env.PUBLIC_URL + '/assets/Img/black-shirt.webp',
...

    {
        ...
        price: 1150,
        image: process.env.PUBLIC_URL + '/assets/Img/white-rd-bl-sneakers.webp',
